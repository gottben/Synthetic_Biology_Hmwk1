...
def main():
    ...
    new_score, new_dict_of_circuit = -1*circuit_forward_prop(best_dict,best_dict,flag=True)
    ...
    new_score, new_dict_of_circuit = -1*circuit_forward_prop(new_best_dict,None,flag=True)
